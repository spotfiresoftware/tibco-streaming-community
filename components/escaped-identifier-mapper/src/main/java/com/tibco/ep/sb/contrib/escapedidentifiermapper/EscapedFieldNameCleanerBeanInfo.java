...
*/
public class EscapedFieldNameCleanerBeanInfo extends SBSimpleBeanInfo {
	...
	*/
	public SBPropertyDescriptor[] getPropertyDescriptorsChecked() throws IntrospectionException {
		SBPropertyDescriptor[] p = { new SBPropertyDescriptor("prefix", EscapedFieldNameCleaner.class)
				.displayName("Prefix to use").description(""), };
		return p;
	}
