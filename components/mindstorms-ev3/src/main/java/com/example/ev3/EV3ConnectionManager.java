...
/**
 * EV3 connection adapter object. This adapter establishes a shared Bluetooth connection to a MINDSTORMS EV3 brick.
 * 
 * No input or output ports; an EV3 Command Adapter or EV3 Status Adapter must be paired with the Connection Manager in
 * order to interact with the robot.
 * 
...
public class EV3ConnectionManager extends Operator implements Parameterizable, ISharableAdapter, Runnable {
    ...
    public EV3ConnectionManager() {
        ...
        setDisplayDescription("The EV3 Connection Manager establishes a shareable Bluetooth connection with the EV3 Brick.");
