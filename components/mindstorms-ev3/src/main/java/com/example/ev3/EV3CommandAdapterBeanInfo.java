    ...
    public SBPropertyDescriptor[] getPropertyDescriptorsChecked() throws IntrospectionException {
        SBPropertyDescriptor[] p = {
                new SBPropertyDescriptor("ConnectionManagerName",
                                         EV3CommandAdapter.class).displayName("Linked Connection Manager name")
                                                                 .description("Name of the Connection Manager adapter to share a connection with."),
                new SBPropertyDescriptor("error",
                                         EV3CommandAdapter.class).displayName("Acceptable Motor Position Error (Degrees)")
